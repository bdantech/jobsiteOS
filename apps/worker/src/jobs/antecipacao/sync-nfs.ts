...
/*
 * A precificação do sacado e a resolução de empresa saíram daqui para
 * `antecipacao/sacado-precificado.ts` quando o funil ganhou duas fontes novas
 * (04s): uma pré-autorização contra o MESMO sacado tem de chegar ao mesmo número
 * que a NF, e duas cópias da régua divergiriam em dinheiro.
 */
import {
  enfileirarLookup,
  resolverEmpresa,
